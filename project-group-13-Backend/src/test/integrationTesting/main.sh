...
currentLine=$(curl -s -X POST "http://localhost:8080/newuser?username=$username&email=$username@no.com&password=passwor1dfd")
printf "$currentLine\n"
currentLine=$(curl -s -X POST "http://localhost:8080/newuser?username=$username2&email=$username@not.com&password=passwor1dfd")
printf "$currentLine\n"
